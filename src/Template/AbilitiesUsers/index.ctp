...
<div class="abilitiesUsers index large-9 medium-8 columns content">
    <h3><?= __('Abilities Users') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($abilitiesUsers as $abilitiesUser): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $abilitiesUser->user_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $abilitiesUser->user_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $abilitiesUser->user_id], ['confirm' => __('Are you sure you want to delete # {0}?', $abilitiesUser->user_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
