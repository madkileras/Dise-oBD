    ...
    <div class="container clearfix">
     <nav class="large-2 medium-4 columns" id="actions-sidebar">
        <ul class="side-nav">
            ...
            <li><label><b><?= _('Gestión de Misiones')?></b></li>
            <li><?= $this->Html->link(__('Lista Misiones'), ['action' => 'indexMisiones']) ?></li>
            <li><?= $this->Html->link(__('Agregar Misión'), ['action' => 'addMisiones']) ?></li>

             <li><?= $this->Html->link(__('Asignar encargados'), ['action' => 'indexEncargados']) ?></li>
