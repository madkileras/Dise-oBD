...
class TasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_TAREA_MISION' => ['type' => 'index', 'columns' => ['mission_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_TAREA_MISION' => ['type' => 'foreign', 'columns' => ['mission_id'], 'references' => ['missions', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
